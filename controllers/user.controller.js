...
const sendUniqueNumberToEmail = (email, matricNumber) => {
    return new Promise((resolve, reject) => {
        const transporter = nodemailer.createTransport({
            service: 'gmail',
            auth: {
                user: 'sibukun05@gmail.com',
                pass: 'wtbg wkni iead arry'
            }
        });

        const mailOptions = {
            from: 'sibukun05@gmail.com',
            to: email,
            subject: 'CHOKHMAH Student Matric Number (S.M.N)',
...
const sendOTPToEmail = (email, otp) => {
    return new Promise((resolve, reject) => {
        ...
        const mailOptions = {
            from: 'sibukun05@gmail.com',
            to: email,
            subject: 'CHOKHMAH forgotten pasword OTP',
